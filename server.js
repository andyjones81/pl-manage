...
const routes3 = require('./app/routes3.js')
...
if (typeof (routes3) !== 'function') {
  console.log(routes3.bind)
  console.log('Warning: the use of bind in routes is deprecated - please check the Prototype Kit documentation for writing routes.')
  routes3.bind(app)
} else {
  app.use('/', routes3)
...
if (typeof (routes4) !== 'function') {
  console.log(routes4.bind)
  console.log('Warning: the use of bind in routes is deprecated - please check the Prototype Kit documentation for writing routes.')
  routes4.bind(app)
} else {
  app.use('/', routes4)
...
if (typeof (routes5) !== 'function') {
  console.log(routes5.bind)
  console.log('Warning: the use of bind in routes is deprecated - please check the Prototype Kit documentation for writing routes.')
  routes5.bind(app)
} else {
  app.use('/', routes5)
...
if (typeof (routes6) !== 'function') {
  console.log(routes6.bind)
  console.log('Warning: the use of bind in routes is deprecated - please check the Prototype Kit documentation for writing routes.')
  routes6.bind(app)
} else {
  app.use('/', routes6)
